 ...
 <div>
            ...
            <center>
              ...
              <form  className="form-inside-input"
                ...
                /> */}
                 ...
                 <Input placeholder="expire time in minutes<60" autoFocus
                  type="text"
                  value={expTime}
      ...
      <button className="btn btn-outline-success bt" onClick={() => setOpen(true)}>+ Card</button>
       <span><button className="btn btn-outline-success bt" onClick={() => setNewGrpflag(true)}>+ Group</button></span>
        ...
        <p>
ShortyUrl is one of the newest tool to shorten lengthy Urls, You can define your own expiration time though the default expiration time is 60 minutes
Go ahead and get your short urls to avoid the headache of handling bookmarks and remembering them. :- Dheeraj Kumar
        </p>
      </div>)}
    </div>
